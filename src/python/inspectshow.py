...
"""
 inspectshow
 Show the tree of submodules, classes, methods and functions in a module.
"""
import inspect
import imp,os, glob
import pkgutil
...
class ModuleShow:
    ...
    def describe_submodules(self, modulestr):
    ...
    def describe_classes(self, module):
    ...
    def describe_function(self, module, name):
    ...
    def describe_subpackages(self, module):
        if module.__name__ in sys.builtin_module_names:
            return
    ...
    def describe(self, module):
        ...
        for ModObj in self.Modules:
            if inspect.ismodule(ModObj):
                self.describe_subpackages(ModObj)
        ...
        for ModObj in self.Modules:
            for name, data in inspect.getmembers(ModObj, inspect.isfunction):
                self.indent()
                self.describe_function(ModObj, name)
                self.dedent()
